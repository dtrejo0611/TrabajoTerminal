...
if __name__ == "__main__":
    ...
    # Pipeline modificado para decodificación por software en Linux (Pop!_OS)
    ...
    print("✅ Cliente iniciado. Esperando la transmisión en el puerto 5000. Presiona Ctrl+C para detener el proceso principal.")
