...
class GPIOController:
    ...
    def __init__(self, pins):
        ...
        try:
            ...
            print(f"⚠️ RPi.GPIO no está disponible: {e}. Usando modo mock (no cambiará hardware).")
    ...
    def set(self, pin, value: bool):
        if pin not in self.pins:
            print(f"⚠️ Pin {pin} no está en la lista de LEDs configurada.")
            return False
...
def stop_stream(process):
    ...
    try:
        ...
        print(f"⚠️ Error al detener el proceso: {e}")
        try:
            process.terminate()
            process.wait(timeout=5)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n⚙️  El sistema está listo. El cliente puede enviar comandos UDP para controlar LEDs.")
